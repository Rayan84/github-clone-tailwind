<template>
  <div class="bg-gray-50 ">
      ...
      <div class="flex space-x-2">
        <div class="flex text-xs">
          <button class="border border-gray-400 rounded rounded-r-none px-3 py-1 flex items-center space-x-1">
            <svg aria-hidden="true" viewBox="0 0 16 16" data-view-component="true" height="16" width="16" class="octicon octicon-eye">
          ...
          <a href="#" class="border border-gray-400 rounded rounded-r-none border-l-0 px-3 py-1 font-semibold hover:text-blue-600">500</a>
        </div>
        ...
        <div class="flex text-xs">
          ...
          <a href="#" class="border border-gray-400 rounded rounded-r-none border-l-0 px-3 py-1 font-semibold hover:text-blue-600">3</a>
        </div>
        ...
        <div class="flex text-xs">
          ...
          <a href="#" class="border border-gray-400 rounded rounded-r-none border-l-0 px-3 py-1 font-semibold hover:text-blue-600">1</a>
        </div>
      </div>
      ...
      <li class="font-semibold">
        ...
        <li>
          <a href="#" class="flex items-center border-b-2 border-transparent hover:border-gray-400 transition ease-in-out duration-150 px-4 pb-3">
            ...
            <div class="text-xs rounded-lg bg-gray-200 px-2 ml-1">106</div>
          </a>
        </li>
        <li>
          <a href="#" class="flex items-center border-b-2 border-transparent hover:border-gray-400 transition ease-in-out duration-150 px-4 pb-3">
            ...
            <div class="text-xs rounded-lg bg-gray-200 px-2 ml-1">6</div>
          </a>
        </li>
        <li>
          <a href="#" class="flex items-center border-b-2 border-transparent hover:border-gray-400 transition ease-in-out duration-150 px-4 pb-3">
    ...
    <div class="container mx-auto	my-8 px-4 flex m-auto max-w-screen-xl">
        ...
        <div class="file-explorer rounded-md rounded-t-none border border-gray-300 text-gray-700 divide-y divide-gray-300">
          ...
          <div class="flex justify-between px-4 py-2">
            <div class="w-4/12 flex items-center">
              ...
              <a href="#" class="hover:underline hover:text-blue-500 ml-3">pages</a>
            </div>
            <div class="w-6/12">
      ...
      <div class="sidebar w-1/4">
        <div class="about">
          ...
          <div class="tags text-xs font-semibold flex items-center flex-wrap mt-2">
            ...
            <a href="#" class="bg-blue-100 hover:200 text-blue-600 rounded-full px-2 py-1 mt-2">css</a>
            <a href="#" class="bg-blue-100 hover:200 text-blue-600 rounded-full px-2 py-1 mt-2">css-framework</a>
            <a href="#" class="bg-blue-100 hover:200 text-blue-600 rounded-full px-2 py-1 mt-2">postcss</a>
            <a href="#" class="bg-blue-100 hover:200 text-blue-600 rounded-full px-2 py-1 mt-2">functional-css</a>
            <a href="#" class="bg-blue-100 hover:200 text-blue-600 rounded-full px-2 py-1 mt-2">utility-classes</a>
            <a href="#" class="bg-blue-100 hover:200 text-blue-600 rounded-full px-2 py-1 mt-2">responsive</a>
          </div>
          <a href="#" class="flex items-center space-x-2 mt-4 group">
            ...
            <span class="text-grey-600 group-hover:text-blue-600">Readme</span>
          </a>
          <a href="#" class="flex items-center space-x-2 mt-4 group">
            ...
            <span class="text-grey-600 group-hover:text-blue-600">MIT License</span>
          </a>
        </div> <!-- end about -->
        <div class="releases border-t border-gray-300 mt-6 pt-6">
          ...
          <a href="#" class="flex mt-4 group items-center">
            ...
            <span class="ml-2">
              ...
              <span class="ml-1 text-xs border-green-500 text-green-600 rounded-full font-semibold inline-block px-2">Latest</span>
        ...
        <div class="used-by border-t border-gray-300 mt-6 pt-6">
          ...
          <div class="mt-4">
            <a href="#" class="flex items-center -space-x-2">
              <img src="data:image/jpeg;base64,
" alt="avatar" class="w-8 border-2 border-white rounded-full">
              <img src="data:image/jpeg;base64," alt="avatar" class="w-8 border-2 border-white rounded-full">
              
              <img src="data:image/jpeg;base64," alt="avatar" class="w-8 border-2 border-white rounded-full">
              <img src="data:image/jpeg;base64," alt="avatar" class="w-8 border-2 border-white rounded-full">
              <span class="text-xs text-blue-600 font-semibold hover:underline" style="margin-left:0.5rem">+ 58,358</span>
            </a>
          </div>
        </div>  <!-- end of used by -->
      ...
      <div class="sidebar w-1/4">
        <div class="pb-5  border-b-2">
          <div class="flex justify-between">
            <h3 class="text-lg mb-3">About</h3>
        ...
        <div class="py-5  border-b-2">
          <h3 class="text-lg mb-3">Releases</h3>
           <p>No releases published</p>
           <a href="#" class="text-blue-500 hover:underline hover:text-blue-700"> Create a new release</a>
        </div>

        <div class="py-5  border-b-2">
          <h3 class="text-lg mb-3">Packages</h3>
           <p>No packages published</p>
           <a href="#" class="text-blue-500 hover:underline hover:text-blue-700"> Publish your first package</a>
        </div>

        <div class="py-7  border-b-2">
          <h3 class="text-lg mb-3">Environment
            <span class="text-xs rounded-lg bg-gray-200 px-2 ml-1">2
            </span>
          </h3>
          <div class="flex items-end">
            <svg aria-hidden="true" viewBox="0 0 16 16" version="1.1" data-view-component="true" height="16" width="16" class="octicon octicon-rocket">
            ...
            <a href="#" class="hover:underline hover:text-blue-500 ml-1 font-bold text-gray-600">github-pages</a>
