<template>
  <div class="text-grey-900 text-sm">
    <nav class="bg-gray-900 text-white px-4 py-3 flex items-center justify-between">
      ...
      <div class="flex items-center space-x-4 text-white">
        ...
        <a href="#" class="flex items-center hover:text-gray-400">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" class="w-3 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
          </svg>
        </a>
        <a href="#" class="flex items-center hover:text-gray-400">
            <img src="https://avatars.githubusercontent.com/u/65650520?s=60&amp;v=4" alt="@Rayan84" class="w-5 h-5 rounded-full">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-3 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
          </svg>
        </a>
    ...
    <footer class="container mx-auto text-xs border-t border-gray-400 py-10 flex items-center justify-between">
      Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia, esse in quo nam commodi corrupti voluptatibus, iure et, reprehenderit accusamus eveniet. Provident molestias animi earum, error autem minus magni voluptatibus totam exercitationem. Incidunt doloribus ut quos cumque commodi tempore natus. Deleniti odit officiis et vitae aperiam ad iure commodi vel autem libero. Amet maiores quia ex non consectetur. Rerum sit consequatur in nesciunt! Cumque veritatis officiis, eveniet quam quae voluptatibus dolores ipsam natus voluptas, laboriosam eos delectus blanditiis repellat temporibus est vel saepe! Praesentium mollitia dolores consequuntur adipisci maiores dolore placeat eius est dicta distinctio, in illo qui debitis officiis, natus similique. Esse tenetur asperiores assumenda ducimus ad laborum incidunt fuga harum doloribus neque nam odio a accusamus modi, vero omnis qui beatae quibusdam veniam accusantium est eligendi laudantium. Quam temporibus saepe, totam asperiores dolores placeat corporis, aliquam iste voluptas fugiat ratione, quas repellendus illo? Nihil ea dolore ipsa architecto ipsam aut quasi. Nesciunt vel obcaecati exercitationem corporis deleniti, illo officia, voluptate optio voluptas repellendus atque laudantium dolore soluta. Neque corporis quasi architecto quis. Omnis quam obcaecati perspiciatis eos et nisi quod blanditiis esse, asperiores sunt totam minus dolores facere illo nobis neque aliquid iusto ducimus explicabo. Ipsa, consequuntur expedita?
